...
public class SpringEffect extends FestivalEffect {
    protected static final String TAG = "SpringEffect";
    ...
    public SpringEffect(Context context) {
        super(context);
        this.maxRand = 200.0f;
        this.dk = 1.0f;
        this.m = 0;
        this.rotateAngel = 0;
        this.resId = new int[]{R.drawable.unlock_spring_particle_01, R.drawable.unlock_spring_particle_02, R.drawable.unlock_spring_particle_03, R.drawable.unlock_spring_particle_04};
    ...
    public void move(float f, float f2) {
        ...
        if (this.m < 4) {
            ...
            if (this.m == 0 || this.m == 1 || this.m == 2) {
                ...
                this.dk = (float) (0.20000000298023224d + (0.1d * new Random().nextInt(9)));
                this.mImageEffect.setX(f - this.dx);
                this.mImageEffect.setY(this.dx + f2);
                this.scaleX = ObjectAnimator.ofFloat(this.mImageEffect, "ScaleX", 0.0f, this.dk);
                this.scaleY = ObjectAnimator.ofFloat(this.mImageEffect, "ScaleY", 0.0f, this.dk);
