...
public class KeyguardEffectViewAbstractTile extends EffectView implements KeyguardEffectViewBase {
    ...
    //private static KeyguardEffectViewAbstractTile sKeyguardEffectViewAbstractTile;
    ...
    /*public static KeyguardEffectViewAbstractTile getInstance(Context context) {
        if (sKeyguardEffectViewAbstractTile == null) {
            sKeyguardEffectViewAbstractTile = new KeyguardEffectViewAbstractTile(context);
            Log.i(TAG, "*** KeyguardEffectView create instance ***");
        }
        return sKeyguardEffectViewAbstractTile;
    }*/
