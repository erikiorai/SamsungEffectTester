...
public class JniSparklingBubblesRenderer implements ISPhysicsJniRenderer {
    private long mNativeJNI = -1;
    private String TAG = "JniSparklingBubblesRenderer";
    ...
    public JniSparklingBubblesRenderer() {
        Log.e(this.TAG, "JniSparklingBubblesRenderer is called");
    }
