...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private static final String TAG = "Liquid_GLTextureView";
    ...
    protected void finalize() throws Throwable {
        try {
            if (this.mGLThread != null) {
                Log.d("Liquid", "finalize()() mGLThread.requestExitAndWait()");
    ...
    public void setRenderer(Renderer renderer) {
        Log.d("Liquid TextureView", "setRenderer()111");
        checkRenderThreadState();
        if (this.mEGLConfigChooser == null) {
            Log.d("Liquid TextureView", "setRenderer() new SimpleEGLConfigChooser()");
            this.mEGLConfigChooser = new SimpleEGLConfigChooser(true);
        }
        if (this.mEGLContextFactory == null) {
            Log.d("Liquid TextureView", "setRenderer() new DefaultContextFactory()");
            this.mEGLContextFactory = new DefaultContextFactory();
        }
        if (this.mEGLWindowSurfaceFactory == null) {
            Log.d("Liquid TextureView", "setRenderer() new DefaultWindowSurfaceFactory()");
            this.mEGLWindowSurfaceFactory = new DefaultWindowSurfaceFactory();
        }
        Log.d("Liquid TextureView", "setRenderer() mRenderer = renderer;");
    ...
    public void onDetachedFromWindow() {
        if (this.mGLThread != null) {
            Log.d("Liquid", "onDetachedFromWindow() mGLThread.requestExitAndWait()");
            this.mGLThread.requestExitAndWait();
        }
        this.mDetached = true;
    ...
    public class DefaultContextFactory implements EGLContextFactory {
        ...
        @Override // com.samsung.android.visualeffect.liquid.GLTextureView.EGLContextFactory
    ...
    public static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        @Override // com.samsung.android.visualeffect.liquid.GLTextureView.EGLWindowSurfaceFactory
    ...
    private abstract class BaseConfigChooser implements EGLConfigChooser {
        ...
        @Override // com.samsung.android.visualeffect.liquid.GLTextureView.EGLConfigChooser
    ...
    private class ComponentSizeChooser extends BaseConfigChooser {
        ...
        @Override // com.samsung.android.visualeffect.liquid.GLTextureView.BaseConfigChooser
            ...
            while (true) {
                try {
                    ...
                    if (event != null) {
                        ...
                        if (view4 != null) {
                            this.currFPSTime = System.currentTimeMillis();
                            long diffFPSTime = this.currFPSTime - this.prevFPSTime;
                            if (diffFPSTime < this.fps_term) {
                                isSwaped = false;
                            } else {
                                isSwaped = true;
    ...
    private void checkRenderThreadState() {
        if (this.mGLThread != null) {
            Log.d("Liquid TextureView", "setRenderer()222");
