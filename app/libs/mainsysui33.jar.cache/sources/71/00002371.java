...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/dialog/InternetDialogController_Factory.class */
public final class InternetDialogController_Factory implements Factory<InternetDialogController> {
    ...
    public static InternetDialogController newInstance(Context context, UiEventLogger uiEventLogger, ActivityStarter activityStarter, AccessPointController accessPointController, SubscriptionManager subscriptionManager, TelephonyManager telephonyManager, WifiManager wifiManager, ConnectivityManager connectivityManager, Handler handler, Executor executor, BroadcastDispatcher broadcastDispatcher, KeyguardUpdateMonitor keyguardUpdateMonitor, GlobalSettings globalSettings, KeyguardStateController keyguardStateController, WindowManager windowManager, ToastFactory toastFactory, Handler handler2, CarrierConfigTracker carrierConfigTracker, LocationController locationController, DialogLaunchAnimator dialogLaunchAnimator, WifiStateWorker wifiStateWorker, FeatureFlags featureFlags) {
        return new InternetDialogController(context, uiEventLogger, activityStarter, accessPointController, subscriptionManager, telephonyManager, wifiManager, connectivityManager, handler, executor, broadcastDispatcher, keyguardUpdateMonitor, globalSettings, keyguardStateController, windowManager, toastFactory, handler2, carrierConfigTracker, locationController, dialogLaunchAnimator, wifiStateWorker, featureFlags);
    }

    /* JADX DEBUG: Method merged with bridge method */
    /* renamed from: get */
    public InternetDialogController m4088get() {
        return newInstance((Context) this.contextProvider.get(), (UiEventLogger) this.uiEventLoggerProvider.get(), (ActivityStarter) this.starterProvider.get(), (AccessPointController) this.accessPointControllerProvider.get(), (SubscriptionManager) this.subscriptionManagerProvider.get(), (TelephonyManager) this.telephonyManagerProvider.get(), (WifiManager) this.wifiManagerProvider.get(), (ConnectivityManager) this.connectivityManagerProvider.get(), (Handler) this.handlerProvider.get(), (Executor) this.mainExecutorProvider.get(), (BroadcastDispatcher) this.broadcastDispatcherProvider.get(), (KeyguardUpdateMonitor) this.keyguardUpdateMonitorProvider.get(), (GlobalSettings) this.globalSettingsProvider.get(), (KeyguardStateController) this.keyguardStateControllerProvider.get(), (WindowManager) this.windowManagerProvider.get(), (ToastFactory) this.toastFactoryProvider.get(), (Handler) this.workerHandlerProvider.get(), (CarrierConfigTracker) this.carrierConfigTrackerProvider.get(), (LocationController) this.locationControllerProvider.get(), (DialogLaunchAnimator) this.dialogLaunchAnimatorProvider.get(), (WifiStateWorker) this.wifiStateWorkerProvider.get(), (FeatureFlags) this.featureFlagsProvider.get());
    }
}