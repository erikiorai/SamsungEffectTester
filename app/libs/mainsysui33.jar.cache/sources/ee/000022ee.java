...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/NightDisplayTile_Factory.class */
public final class NightDisplayTile_Factory implements Factory<NightDisplayTile> {
    ...
    /* renamed from: get */
    public NightDisplayTile m4031get() {
        return newInstance((QSHost) this.hostProvider.get(), (Looper) this.backgroundLooperProvider.get(), (Handler) this.mainHandlerProvider.get(), (FalsingManager) this.falsingManagerProvider.get(), (MetricsLogger) this.metricsLoggerProvider.get(), (StatusBarStateController) this.statusBarStateControllerProvider.get(), (ActivityStarter) this.activityStarterProvider.get(), (QSLogger) this.qsLoggerProvider.get(), (LocationController) this.locationControllerProvider.get(), (ColorDisplayManager) this.colorDisplayManagerProvider.get(), (NightDisplayListenerModule.Builder) this.nightDisplayListenerBuilderProvider.get());
    }
}