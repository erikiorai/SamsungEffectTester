...
/* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromDozingTransitionInteractor$listenForDozingToLockscreen$1.class */
public final class FromDozingTransitionInteractor$listenForDozingToLockscreen$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    ...
    /* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromDozingTransitionInteractor$listenForDozingToLockscreen$1$2.class */
    public final /* synthetic */ class AnonymousClass2 extends AdaptedFunctionReference implements Function3<DozeTransitionModel, TransitionStep, Continuation<? super Pair<? extends DozeTransitionModel, ? extends TransitionStep>>, Object> {
        ...
        public final Object invoke(DozeTransitionModel dozeTransitionModel, TransitionStep transitionStep, Continuation<? super Pair<DozeTransitionModel, TransitionStep>> continuation) {
            return FromDozingTransitionInteractor$listenForDozingToLockscreen$1.invokeSuspend$lambda$0(dozeTransitionModel, transitionStep, continuation);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow sample = FlowKt.sample(dozeTransitionModel, keyguardTransitionInteractor.getStartedKeyguardTransitionStep(), AnonymousClass2.INSTANCE);
            final FromDozingTransitionInteractor fromDozingTransitionInteractor = this.this$0;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromDozingTransitionInteractor$listenForDozingToLockscreen$1.3
                ...
                public final Object emit(Pair<DozeTransitionModel, TransitionStep> pair, Continuation<? super Unit> continuation) {
                    ...
                    if (DozeStateModel.Companion.isDozeOff(dozeTransitionModel2.getTo())) {
                        KeyguardState to = transitionStep.getTo();
                        KeyguardState keyguardState = KeyguardState.DOZING;
                        if (to == keyguardState) {
                            keyguardTransitionRepository = FromDozingTransitionInteractor.this.keyguardTransitionRepository;
                            keyguardTransitionRepository.startTransition(new TransitionInfo(FromDozingTransitionInteractor.this.getName(), keyguardState, KeyguardState.LOCKSCREEN, FromDozingTransitionInteractor.m3004getAnimatorLRDsOJo$default(FromDozingTransitionInteractor.this, 0L, 1, null)));
                        }
                    }
