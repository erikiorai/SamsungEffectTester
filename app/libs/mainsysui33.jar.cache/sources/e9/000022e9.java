...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/MicrophoneToggleTile_Factory.class */
public final class MicrophoneToggleTile_Factory implements Factory<MicrophoneToggleTile> {
    ...
    /* renamed from: get */
    public MicrophoneToggleTile m4029get() {
        return newInstance((QSHost) this.hostProvider.get(), (Looper) this.backgroundLooperProvider.get(), (Handler) this.mainHandlerProvider.get(), (MetricsLogger) this.metricsLoggerProvider.get(), (FalsingManager) this.falsingManagerProvider.get(), (StatusBarStateController) this.statusBarStateControllerProvider.get(), (ActivityStarter) this.activityStarterProvider.get(), (QSLogger) this.qsLoggerProvider.get(), (IndividualSensorPrivacyController) this.sensorPrivacyControllerProvider.get(), (KeyguardStateController) this.keyguardStateControllerProvider.get());
    }
}