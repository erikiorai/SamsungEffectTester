...
/* loaded from: mainsysui33.jar:androidx/recyclerview/widget/LinearLayoutManager.class */
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/LinearLayoutManager$AnchorInfo.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/LinearLayoutManager$LayoutChunkResult.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/LinearLayoutManager$LayoutState.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/LinearLayoutManager$SavedState.class */
    ...
    private boolean updateAnchorFromChildren(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (z == z2 && (findReferenceChild = findReferenceChild(recycler, state, anchorInfo.mLayoutFromEnd, z2)) != null) {
    ...
    public PointF computeScrollVectorForPosition(int i) {
        ...
        return this.mOrientation == 0 ? new PointF(i2, ActionBarShadowController.ELEVATION_LOW) : new PointF(ActionBarShadowController.ELEVATION_LOW, i2);
    }
    ...
    */
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (this.mOrientation == 1) {
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                i3 = i5 - layoutChunkResult.mConsumed;
            } else {
                int i6 = layoutState.mOffset;
                int i7 = decoratedMeasurementInOther;
                i3 = i6;
                i = i7;
                i2 = layoutChunkResult.mConsumed + i6;
            }
        } else {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (anchorInfo4.mLayoutFromEnd) {
            ...
            layoutState9.mExtraFillSpace = i20;
        ...
        if (getChildCount() > 0) {
            ...
            i23 = i3 + fixLayoutEndGap;
            i24 = i4 + fixLayoutEndGap;
        }
