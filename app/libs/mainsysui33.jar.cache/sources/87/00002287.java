...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/AlarmTile_Factory.class */
public final class AlarmTile_Factory implements Factory<AlarmTile> {
    ...
    /* renamed from: get */
    public AlarmTile m3976get() {
        return newInstance((QSHost) this.hostProvider.get(), (Looper) this.backgroundLooperProvider.get(), (Handler) this.mainHandlerProvider.get(), (FalsingManager) this.falsingManagerProvider.get(), (MetricsLogger) this.metricsLoggerProvider.get(), (StatusBarStateController) this.statusBarStateControllerProvider.get(), (ActivityStarter) this.activityStarterProvider.get(), (QSLogger) this.qsLoggerProvider.get(), (UserTracker) this.userTrackerProvider.get(), (NextAlarmController) this.nextAlarmControllerProvider.get());
    }
}