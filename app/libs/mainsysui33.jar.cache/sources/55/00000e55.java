...
/* loaded from: mainsysui33.jar:com/android/settingslib/fuelgauge/BatterySaverUtils.class */
public class BatterySaverUtils {

    /* loaded from: mainsysui33.jar:com/android/settingslib/fuelgauge/BatterySaverUtils$Parameters.class */
    ...
    public static boolean setPowerSaveMode(Context context, boolean z, boolean z2) {
        synchronized (BatterySaverUtils.class) {
            try {
                ContentResolver contentResolver = context.getContentResolver();
                Bundle bundle = new Bundle(1);
                bundle.putBoolean(PowerNotificationWarnings.EXTRA_CONFIRM_ONLY, false);
