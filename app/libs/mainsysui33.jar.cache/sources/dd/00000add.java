...
/* loaded from: mainsysui33.jar:com/airbnb/lottie/utils/GammaEvaluator.class */
public class GammaEvaluator {
    ...
    public static int evaluate(float f, int i, int i2) {
        ...
        float OECF_sRGB3 = OECF_sRGB(EOCF_sRGB3 + (f * (EOCF_sRGB6 - EOCF_sRGB3)));
        return (Math.round(OECF_sRGB * 255.0f) << 16) | (Math.round((f2 + (((((i2 >> 24) & 255) / 255.0f) - f2) * f)) * 255.0f) << 24) | (Math.round(OECF_sRGB2 * 255.0f) << 8) | Math.round(OECF_sRGB3 * 255.0f);
    }
}