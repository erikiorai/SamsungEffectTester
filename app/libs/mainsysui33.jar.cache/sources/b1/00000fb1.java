...
/* loaded from: mainsysui33.jar:com/android/systemui/GuestResumeSessionReceiver_ResetSessionDialog_Factory.class */
public final class C0052GuestResumeSessionReceiver_ResetSessionDialog_Factory {
    public final Provider<Context> contextProvider;
    public final Provider<UiEventLogger> uiEventLoggerProvider;
    public final Provider<UserSwitcherController> userSwitcherControllerProvider;

    public C0052GuestResumeSessionReceiver_ResetSessionDialog_Factory(Provider<Context> provider, Provider<UserSwitcherController> provider2, Provider<UiEventLogger> provider3) {
        this.contextProvider = provider;
        this.userSwitcherControllerProvider = provider2;
        this.uiEventLoggerProvider = provider3;
    }

    public static C0052GuestResumeSessionReceiver_ResetSessionDialog_Factory create(Provider<Context> provider, Provider<UserSwitcherController> provider2, Provider<UiEventLogger> provider3) {
        return new C0052GuestResumeSessionReceiver_ResetSessionDialog_Factory(provider, provider2, provider3);
    }
