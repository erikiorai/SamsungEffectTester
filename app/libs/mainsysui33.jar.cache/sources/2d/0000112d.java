...
/* loaded from: mainsysui33.jar:com/android/systemui/assist/ui/CornerPathRenderer.class */
public abstract class CornerPathRenderer {

    /* loaded from: mainsysui33.jar:com/android/systemui/assist/ui/CornerPathRenderer$Corner.class */
    public enum Corner {
        BOTTOM_LEFT,
        BOTTOM_RIGHT,
        TOP_RIGHT,
    ...
    public final PointF normalAt(List<PointF> list, int i) {
        ...
        if (i == list.size() - 1) {
            pointF2 = new PointF(ActionBarShadowController.ELEVATION_LOW, ActionBarShadowController.ELEVATION_LOW);
        } else {
    ...
    public final PointF normalize(PointF pointF) {
        ...
        if (magnitude == ActionBarShadowController.ELEVATION_LOW) {
            return pointF;
        }
