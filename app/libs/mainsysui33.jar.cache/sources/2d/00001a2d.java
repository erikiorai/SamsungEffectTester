...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.FromLockscreenTransitionInteractor$listenForLockscreenToGone$1", f = "FromLockscreenTransitionInteractor.kt", l = {160}, m = "invokeSuspend")
/* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromLockscreenTransitionInteractor$listenForLockscreenToGone$1.class */
public final class FromLockscreenTransitionInteractor$listenForLockscreenToGone$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    ...
    /* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromLockscreenTransitionInteractor$listenForLockscreenToGone$1$2.class */
    public final /* synthetic */ class AnonymousClass2 extends AdaptedFunctionReference implements Function3<Boolean, TransitionStep, Continuation<? super Pair<? extends Boolean, ? extends TransitionStep>>, Object> {
        ...
        public final Object invoke(boolean z, TransitionStep transitionStep, Continuation<? super Pair<Boolean, TransitionStep>> continuation) {
            return FromLockscreenTransitionInteractor$listenForLockscreenToGone$1.invokeSuspend$lambda$0(z, transitionStep, continuation);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow sample = FlowKt.sample(isKeyguardGoingAway, keyguardTransitionInteractor.getStartedKeyguardTransitionStep(), AnonymousClass2.INSTANCE);
