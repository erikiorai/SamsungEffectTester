...
/* loaded from: mainsysui33.jar:com/android/systemui/log/dagger/LogModule_ProvideLSShadeTransitionControllerBufferFactory.class */
public final class LogModule_ProvideLSShadeTransitionControllerBufferFactory implements Factory<LogBuffer> {
    ...
    /* renamed from: get */
    public LogBuffer m3111get() {
        return provideLSShadeTransitionControllerBuffer((LogBufferFactory) this.factoryProvider.get());
    }
}