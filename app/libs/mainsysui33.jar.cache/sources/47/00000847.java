...
/* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView.class */
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$7.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$Adapter.class */
    public static abstract class Adapter<VH extends ViewHolder> {
        private final AdapterDataObservable mObservable = new AdapterDataObservable();
        private boolean mHasStableIds = false;
        private StateRestorationPolicy mStateRestorationPolicy = StateRestorationPolicy.ALLOW;

        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$Adapter$StateRestorationPolicy.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$AdapterDataObservable.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$AdapterDataObserver.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ChildDrawingOrderCallback.class */
    public interface ChildDrawingOrderCallback {
        int onGetChildDrawingOrder(int i, int i2);
    }

    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$EdgeEffectFactory.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ItemAnimator.class */
    public static abstract class ItemAnimator {
        ...
        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemAnimatorFinishedListener.class */
        public interface ItemAnimatorFinishedListener {
            void onAnimationsFinished();
        }

        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemAnimatorListener.class */
        public interface ItemAnimatorListener {
            void onAnimationFinished(ViewHolder viewHolder);
        }

        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ItemAnimator$ItemHolderInfo.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ItemAnimatorRestoreListener.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ItemDecoration.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$LayoutManager.class */
    public static abstract class LayoutManager {
        ...
        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$LayoutManager$LayoutPrefetchRegistry.class */
        public interface LayoutPrefetchRegistry {
            void addPosition(int i, int i2);
        }

        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$LayoutManager$Properties.class */
        ...
        */
        ...
        public void ignoreView(View view) {
            ...
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            childViewHolderInt.addFlags(ViewHolder.FLAG_IGNORE);
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (this.mRecyclerView.canScrollVertically(-1) || this.mRecyclerView.canScrollHorizontally(-1)) {
                accessibilityNodeInfoCompat.addAction(ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                accessibilityNodeInfoCompat.setScrollable(true);
            }
            if (this.mRecyclerView.canScrollVertically(1) || this.mRecyclerView.canScrollHorizontally(1)) {
                accessibilityNodeInfoCompat.addAction(ViewHolder.FLAG_APPEARED_IN_PRE_LAYOUT);
                accessibilityNodeInfoCompat.setScrollable(true);
            }
        ...
        public boolean performAccessibilityAction(Recycler recycler, State state, int i, Bundle bundle) {
            ...
            if (this.mRecyclerView.getMatrix().isIdentity()) {
                i4 = height;
                i5 = width;
                if (this.mRecyclerView.getGlobalVisibleRect(rect)) {
                    i4 = rect.height();
                    i5 = rect.width();
                }
            }
            if (i == 4096) {
                paddingTop = this.mRecyclerView.canScrollVertically(1) ? (i4 - getPaddingTop()) - getPaddingBottom() : 0;
                i2 = paddingTop;
                if (this.mRecyclerView.canScrollHorizontally(1)) {
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$LayoutParams.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$OnChildAttachStateChangeListener.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$OnFlingListener.class */
    public static abstract class OnFlingListener {
        public abstract boolean onFling(int i, int i2);
    }

    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$OnItemTouchListener.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$OnScrollListener.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$RecycledViewPool.class */
    public static class RecycledViewPool {
        public SparseArray<ScrapData> mScrap = new SparseArray<>();
        public int mAttachCount = 0;

        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$RecycledViewPool$ScrapData.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$Recycler.class */
    public final class Recycler {
        ...
        */
        public ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (RecyclerView.this.mState.isPreLayout()) {
                viewHolder2 = getChangedScrapViewForPosition(i);
                viewHolder = viewHolder2;
                if (viewHolder2 != null) {
                    z2 = true;
                    ...
                    boolean z4 = z2;
                    if (viewHolder2 == null) {
                        ViewHolder scrapOrHiddenOrCachedHolderForPosition = getScrapOrHiddenOrCachedHolderForPosition(i, z);
                        viewHolder3 = scrapOrHiddenOrCachedHolderForPosition;
                        z4 = z2;
                        if (scrapOrHiddenOrCachedHolderForPosition != null) {
                            if (validateViewHolderForOffsetPosition(scrapOrHiddenOrCachedHolderForPosition)) {
                                z4 = true;
                                viewHolder3 = scrapOrHiddenOrCachedHolderForPosition;
                            } else {
                                if (!z) {
                                    ...
                                    recycleViewHolderInternal(scrapOrHiddenOrCachedHolderForPosition);
                                }
                                viewHolder3 = null;
                                z4 = z2;
                            }
                    ...
                    if (viewHolder3 == null) {
                        ...
                        if (RecyclerView.this.mAdapter.hasStableIds()) {
                            ViewHolder scrapOrCachedViewForId = getScrapOrCachedViewForId(RecyclerView.this.mAdapter.getItemId(findPositionOffset), itemViewType, z);
                            viewHolder3 = scrapOrCachedViewForId;
                            z3 = z4;
                            if (scrapOrCachedViewForId != null) {
                                scrapOrCachedViewForId.mPosition = findPositionOffset;
                                z3 = true;
                                viewHolder3 = scrapOrCachedViewForId;
                            }
                        }
                        ...
                        if (viewHolder3 == null) {
                            viewHolder5 = getRecycledViewPool().getRecycledView(itemViewType);
                            if (viewHolder5 != null) {
                                viewHolder5.resetInternal();
                                if (RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST) {
                                    invalidateDisplayListInt(viewHolder5);
                                }
                            }
                        }
                        ...
                        if (viewHolder5 == null) {
                            ...
                            if (j == RecyclerView.FOREVER_NS || this.mRecyclerPool.willCreateInTime(itemViewType, nanoTime, j)) {
                                RecyclerView recyclerView = RecyclerView.this;
                                viewHolder4 = recyclerView.mAdapter.createViewHolder(recyclerView, itemViewType);
                                if (RecyclerView.ALLOW_THREAD_GAP_WORK && (findNestedRecyclerView = RecyclerView.findNestedRecyclerView(viewHolder4.itemView)) != null) {
                                    viewHolder4.mNestedRecyclerView = new WeakReference<>(findNestedRecyclerView);
                                }
                                this.mRecyclerPool.factorInCreateTime(itemViewType, RecyclerView.this.getNanoTime() - nanoTime);
                                if (z3 && !RecyclerView.this.mState.isPreLayout() && viewHolder4.hasAnyOfTheFlags(ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST)) {
                                    viewHolder4.setFlags(0, ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                                    if (RecyclerView.this.mState.mRunSimpleAnimations) {
                                        int buildAdapterChangeFlagsForAnimations = ItemAnimator.buildAdapterChangeFlagsForAnimations(viewHolder4);
                                        RecyclerView recyclerView2 = RecyclerView.this;
                                        RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(viewHolder4, recyclerView2.mItemAnimator.recordPreLayoutInformation(recyclerView2.mState, viewHolder4, buildAdapterChangeFlagsForAnimations | ViewHolder.FLAG_APPEARED_IN_PRE_LAYOUT, viewHolder4.getUnmodifiedPayloads()));
                                    }
                                }
                                if (!RecyclerView.this.mState.isPreLayout() && viewHolder4.isBound()) {
                                    viewHolder4.mPreLayoutPosition = i;
                                } else if (viewHolder4.isBound() || viewHolder4.needsUpdate() || viewHolder4.isInvalid()) {
                                    tryBindViewHolderByDeadline = tryBindViewHolderByDeadline(viewHolder4, RecyclerView.this.mAdapterHelper.findPositionOffset(i), i, j);
                                    layoutParams = viewHolder4.itemView.getLayoutParams();
                                    if (layoutParams != null) {
                                    ...
                                    layoutParams2.mViewHolder = viewHolder4;
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$RecyclerListener.class */
    public interface RecyclerListener {
        void onViewRecycled(ViewHolder viewHolder);
    }

    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$RecyclerViewDataObserver.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$SavedState.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$SmoothScroller.class */
    public static abstract class SmoothScroller {
        ...
        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$SmoothScroller$Action.class */
        ...
        /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$SmoothScroller$ScrollVectorProvider.class */
        ...
        public void onAnimation(int i, int i2) {
            ...
            if (this.mPendingInitialRun && this.mTargetView == null && this.mLayoutManager != null && (computeScrollVectorForPosition = computeScrollVectorForPosition(this.mTargetPosition)) != null) {
                ...
                if (f != ActionBarShadowController.ELEVATION_LOW || computeScrollVectorForPosition.y != ActionBarShadowController.ELEVATION_LOW) {
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$State.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$StretchEdgeEffectFactory.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ViewCacheExtension.class */
    public static abstract class ViewCacheExtension {
    }

    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ViewFlinger.class */
    public class ViewFlinger implements Runnable {
        ...
        public final int computeScrollDuration(int i, int i2) {
            ...
            boolean z = abs > abs2;
            RecyclerView recyclerView = RecyclerView.this;
            return Math.min((int) ((((z ? abs : abs2) / (z ? recyclerView.getWidth() : recyclerView.getHeight())) + 1.0f) * 300.0f), (int) RecyclerView.MAX_SCROLL_DURATION);
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if ((smoothScroller2 != null && smoothScroller2.isPendingInitialRun()) || !z) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i3, i);
                    }
                } else {
                    if (RecyclerView.this.getOverScrollMode() != 2) {
    ...
    /* loaded from: mainsysui33.jar:androidx/recyclerview/widget/RecyclerView$ViewHolder.class */
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (int i2 = 0; i2 < this.mChildHelper.getChildCount(); i2++) {
                ...
                if (!childViewHolderInt2.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(childViewHolderInt2)) {
                    ...
                    boolean hasAnyOfTheFlags = childViewHolderInt2.hasAnyOfTheFlags(ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                    int i3 = buildAdapterChangeFlagsForAnimations;
                    if (!hasAnyOfTheFlags) {
                        i3 = buildAdapterChangeFlagsForAnimations | ViewHolder.FLAG_APPEARED_IN_PRE_LAYOUT;
                    }
        ...
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.5
            ...
            public void detachViewFromParent(int i) {
                ...
                if (childAt != null && (childViewHolderInt = RecyclerView.getChildViewHolderInt(childAt)) != null) {
                    ...
                    childViewHolderInt.addFlags(ViewHolder.FLAG_TMP_DETACHED);
                }
    ...
    */
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        if (view2 != null) {
            ...
            if (view2 != this) {
                if (view2 == view) {
                    z2 = false;
                } else if (findContainingItemView(view2) == null) {
                    return false;
                } else {
    ...
    private void nestedScrollByInternal(int i, int i2, MotionEvent motionEvent, int i3) {
        ...
        if (layoutManager == null) {
            ...
            boolean z = canScrollVertically ? canScrollHorizontally | 2 : canScrollHorizontally;
            ...
            startNestedScroll(z, i3);
            int i4 = releaseHorizontalGlow;
            ...
            if (dispatchNestedPreScroll(canScrollHorizontally ? releaseHorizontalGlow : 0, canScrollVertically ? releaseVerticalGlow : 0, this.mReusableIntPair, this.mScrollOffset, i3)) {
                ...
                i4 = releaseHorizontalGlow - iArr2[0];
                i5 = releaseVerticalGlow - iArr2[1];
            }
            int i6 = canScrollHorizontally ? i4 : 0;
            int i7 = 0;
    ...
    */
    private void pullGlows(float f, float f2, float f3, float f4) {
        ...
        if (f2 < ActionBarShadowController.ELEVATION_LOW) {
            ...
            if (f4 >= ActionBarShadowController.ELEVATION_LOW) {
                ...
                z = true;
            } else if (f4 > ActionBarShadowController.ELEVATION_LOW) {
                ensureBottomGlow();
                EdgeEffectCompat.onPullDistance(this.mBottomGlow, f4 / getHeight(), 1.0f - (f / getWidth()));
                z = true;
            }
            if (z && f2 == ActionBarShadowController.ELEVATION_LOW && f4 == ActionBarShadowController.ELEVATION_LOW) {
                return;
            }
    ...
    private int releaseHorizontalGlow(int i, float f) {
        ...
        EdgeEffect edgeEffect = this.mLeftGlow;
        float f2 = 0.0f;
        if (edgeEffect == null || EdgeEffectCompat.getDistance(edgeEffect) == ActionBarShadowController.ELEVATION_LOW) {
            EdgeEffect edgeEffect2 = this.mRightGlow;
            f2 = 0.0f;
            if (edgeEffect2 != null) {
                f2 = 0.0f;
                if (EdgeEffectCompat.getDistance(edgeEffect2) != ActionBarShadowController.ELEVATION_LOW) {
                    if (canScrollHorizontally(1)) {
                        this.mRightGlow.onRelease();
                        f2 = 0.0f;
                    } else {
                        f2 = EdgeEffectCompat.onPullDistance(this.mRightGlow, width, height);
                        if (EdgeEffectCompat.getDistance(this.mRightGlow) == ActionBarShadowController.ELEVATION_LOW) {
                            this.mRightGlow.onRelease();
                        }
                    }
                    invalidate();
            ...
            if (canScrollHorizontally(-1)) {
                ...
                if (EdgeEffectCompat.getDistance(this.mLeftGlow) == ActionBarShadowController.ELEVATION_LOW) {
                    this.mLeftGlow.onRelease();
                }
            }
            invalidate();
    ...
    private int releaseVerticalGlow(int i, float f) {
        ...
        if (edgeEffect == null || EdgeEffectCompat.getDistance(edgeEffect) == ActionBarShadowController.ELEVATION_LOW) {
            ...
            if (edgeEffect2 != null) {
                ...
                if (EdgeEffectCompat.getDistance(edgeEffect2) != ActionBarShadowController.ELEVATION_LOW) {
                    if (canScrollVertically(1)) {
                        ...
                        if (EdgeEffectCompat.getDistance(this.mBottomGlow) == ActionBarShadowController.ELEVATION_LOW) {
                            this.mBottomGlow.onRelease();
                        }
                    }
                    invalidate();
            ...
            if (canScrollVertically(-1)) {
                ...
                if (EdgeEffectCompat.getDistance(this.mTopGlow) == ActionBarShadowController.ELEVATION_LOW) {
                    this.mTopGlow.onRelease();
                }
            }
            invalidate();
    ...
    private boolean stopGlowAnimations(MotionEvent motionEvent) {
        boolean z;
        EdgeEffect edgeEffect = this.mLeftGlow;
        if (edgeEffect == null || EdgeEffectCompat.getDistance(edgeEffect) == ActionBarShadowController.ELEVATION_LOW || canScrollHorizontally(-1)) {
            z = false;
        } else {
            EdgeEffectCompat.onPullDistance(this.mLeftGlow, ActionBarShadowController.ELEVATION_LOW, 1.0f - (motionEvent.getY() / getHeight()));
            z = true;
        }
        EdgeEffect edgeEffect2 = this.mRightGlow;
        boolean z2 = z;
        if (edgeEffect2 != null) {
            ...
            if (EdgeEffectCompat.getDistance(edgeEffect2) != ActionBarShadowController.ELEVATION_LOW) {
                z2 = z;
                if (!canScrollHorizontally(1)) {
                    EdgeEffectCompat.onPullDistance(this.mRightGlow, ActionBarShadowController.ELEVATION_LOW, motionEvent.getY() / getHeight());
                    z2 = true;
                }
            }
        }
        ...
        if (edgeEffect3 != null) {
            z3 = z2;
            if (EdgeEffectCompat.getDistance(edgeEffect3) != ActionBarShadowController.ELEVATION_LOW) {
                z3 = z2;
                if (!canScrollVertically(-1)) {
                    EdgeEffectCompat.onPullDistance(this.mTopGlow, ActionBarShadowController.ELEVATION_LOW, motionEvent.getX() / getWidth());
                    z3 = true;
                }
            }
        }
        EdgeEffect edgeEffect4 = this.mBottomGlow;
        if (edgeEffect4 != null && EdgeEffectCompat.getDistance(edgeEffect4) != ActionBarShadowController.ELEVATION_LOW && !canScrollVertically(1)) {
            EdgeEffectCompat.onPullDistance(this.mBottomGlow, ActionBarShadowController.ELEVATION_LOW, 1.0f - (motionEvent.getX() / getWidth()));
            z3 = true;
        }
        return z3;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (edgeEffect == null || edgeEffect.isFinished()) {
            ...
            canvas.translate((-getHeight()) + paddingBottom, ActionBarShadowController.ELEVATION_LOW);
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x003c, code lost:
        if (java.lang.Math.abs(r6) < r5.mMinFlingVelocity) goto L76;
     */
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0051, code lost:
        if (java.lang.Math.abs(r7) < r5.mMinFlingVelocity) goto L75;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean fling(int i, int i2) {
        ...
        if (layoutManager == null) {
            ...
            if (i4 != 0) {
                EdgeEffect edgeEffect3 = this.mTopGlow;
                if (edgeEffect3 == null || EdgeEffectCompat.getDistance(edgeEffect3) == ActionBarShadowController.ELEVATION_LOW) {
                    EdgeEffect edgeEffect4 = this.mBottomGlow;
                    i6 = i4;
                    if (edgeEffect4 != null) {
                        i6 = i4;
                        if (EdgeEffectCompat.getDistance(edgeEffect4) != ActionBarShadowController.ELEVATION_LOW) {
            ...
            if (onFlingListener == null || !onFlingListener.onFling(i5, i6)) {
                if (z) {
                    ...
                    if (canScrollVertically) {
                        z2 = canScrollHorizontally | 2;
                    }
                    startNestedScroll(z2, 1);
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (f == ActionBarShadowController.ELEVATION_LOW && f2 == ActionBarShadowController.ELEVATION_LOW) {
            return false;
        }
    ...
    */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (canScrollVertically) {
                z4 = canScrollHorizontally | 2;
            }
            startNestedScroll(z4, 0);
            z = false;
        } else if (actionMasked == 1) {
            ...
            if ((f == ActionBarShadowController.ELEVATION_LOW && f2 == ActionBarShadowController.ELEVATION_LOW) || !fling((int) f, (int) f2)) {
                setScrollState(0);
            }
            resetScroll();
            z = true;
            ...
            if (this.mScrollState != 1) {
                int i6 = i2;
                if (canScrollHorizontally) {
                    i = i2 > 0 ? Math.max(0, i2 - this.mTouchSlop) : Math.min(0, i2 + this.mTouchSlop);
                    i6 = i;
                    if (i != 0) {
                        z2 = true;
                        int i7 = i3;
                        z3 = z2;
                        if (canScrollVertically) {
                            int max = i3 > 0 ? Math.max(0, i3 - this.mTouchSlop) : Math.min(0, i3 + this.mTouchSlop);
                            i7 = max;
                            z3 = z2;
                            if (max != 0) {
                                z3 = true;
            ...
            if (this.mScrollState == 1) {
                ...
                iArr3[0] = 0;
                iArr3[1] = 0;
                int releaseHorizontalGlow = i4 - releaseHorizontalGlow(i4, motionEvent.getY());
                int releaseVerticalGlow = i5 - releaseVerticalGlow(i5, motionEvent.getX());
                int i8 = releaseHorizontalGlow;
                int i9 = releaseVerticalGlow;
                if (dispatchNestedPreScroll(canScrollHorizontally ? releaseHorizontalGlow : 0, canScrollVertically ? releaseVerticalGlow : 0, this.mReusableIntPair, this.mScrollOffset, 0)) {
                    ...
                    i8 = releaseHorizontalGlow - iArr4[0];
                    i9 = releaseVerticalGlow - iArr4[1];
                ...
                if (scrollByInternal(canScrollHorizontally ? i8 : 0, canScrollVertically ? i9 : 0, motionEvent, 0)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                GapWorker gapWorker = this.mGapWorker;
                z = false;
                if (gapWorker != null) {
                    ...
                    gapWorker.postFromTraversal(this, i8, i9);
                    z = false;
                }
            }
        } else if (actionMasked == 3) {
    ...
    public boolean scrollByInternal(int i, int i2, MotionEvent motionEvent, int i3) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        dispatchNestedScroll(i4, i7, i6, i5, this.mScrollOffset, i3, iArr3);
        int[] iArr4 = this.mReusableIntPair;
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent != null && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                pullGlows(motionEvent.getX(), i6 - i8, motionEvent.getY(), i5 - i9);
            }
    ...
    public final void suppressLayout(boolean z) {
        if (z != this.mLayoutSuppressed) {
            ...
            if (z) {
                ...
                onTouchEvent(MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, ActionBarShadowController.ELEVATION_LOW, ActionBarShadowController.ELEVATION_LOW, 0));
