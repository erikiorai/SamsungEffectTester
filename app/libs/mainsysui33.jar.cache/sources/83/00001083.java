...
/* loaded from: mainsysui33.jar:com/android/systemui/accessibility/floatingmenu/ItemDelegateCompat.class */
public final class ItemDelegateCompat extends RecyclerViewAccessibilityDelegate.ItemDelegate {
    ...
    public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        accessibilityNodeInfoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(accessibilityFloatingMenuView.isOvalShape() ? R$id.action_move_to_edge_and_hide : R$id.action_move_out_edge_and_show, resources.getString(accessibilityFloatingMenuView.isOvalShape() ? R$string.accessibility_floating_button_action_move_to_edge_and_hide_to_half : R$string.accessibility_floating_button_action_move_out_edge_and_show)));
    }
