...
/* loaded from: mainsysui33.jar:com/airbnb/lottie/animation/keyframe/TransformKeyframeAnimation.class */
public class TransformKeyframeAnimation {
    ...
    public <T> boolean applyValueCallback(T t, LottieValueCallback<T> lottieValueCallback) {
        ...
        if (t == LottieProperty.TRANSFORM_ANCHOR_POINT) {
            ...
            if (baseKeyframeAnimation6 == null) {
                this.rotation = new ValueCallbackKeyframeAnimation(lottieValueCallback, Float.valueOf((float) ActionBarShadowController.ELEVATION_LOW));
                return true;
            }
            ...
            if (floatKeyframeAnimation2 == null) {
                this.skew = new FloatKeyframeAnimation(Collections.singletonList(new Keyframe(Float.valueOf((float) ActionBarShadowController.ELEVATION_LOW))));
            }
            ...
            if (floatKeyframeAnimation == null) {
                this.skewAngle = new FloatKeyframeAnimation(Collections.singletonList(new Keyframe(Float.valueOf((float) ActionBarShadowController.ELEVATION_LOW))));
            }
    ...
    public Matrix getMatrix() {
        ...
        if (baseKeyframeAnimation != null) {
            ...
            float f = value.x;
            if (f != ActionBarShadowController.ELEVATION_LOW || value.y != ActionBarShadowController.ELEVATION_LOW) {
        ...
        if (baseKeyframeAnimation4 != null) {
            ...
            float f3 = value3.x;
            if (f3 != ActionBarShadowController.ELEVATION_LOW || value3.y != ActionBarShadowController.ELEVATION_LOW) {
