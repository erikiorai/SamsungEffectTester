...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToLockscreen$1", f = "FromOccludedTransitionInteractor.kt", l = {73}, m = "invokeSuspend")
/* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromOccludedTransitionInteractor$listenForOccludedToLockscreen$1.class */
public final class FromOccludedTransitionInteractor$listenForOccludedToLockscreen$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    ...
    /* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromOccludedTransitionInteractor$listenForOccludedToLockscreen$1$2.class */
    public final /* synthetic */ class AnonymousClass2 extends AdaptedFunctionReference implements Function3<Boolean, TransitionStep, Continuation<? super Pair<? extends Boolean, ? extends TransitionStep>>, Object> {
        ...
        public final Object invoke(boolean z, TransitionStep transitionStep, Continuation<? super Pair<Boolean, TransitionStep>> continuation) {
            return FromOccludedTransitionInteractor$listenForOccludedToLockscreen$1.invokeSuspend$lambda$0(z, transitionStep, continuation);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow sample = FlowKt.sample(isKeyguardOccluded, keyguardTransitionInteractor.getStartedKeyguardTransitionStep(), AnonymousClass2.INSTANCE);
            final FromOccludedTransitionInteractor fromOccludedTransitionInteractor = this.this$0;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToLockscreen$1.3
                ...
                public final Object emit(Pair<Boolean, TransitionStep> pair, Continuation<? super Unit> continuation) {
                    ...
                    ValueAnimator m3033getAnimatorLRDsOJo;
                    ...
                    if (!booleanValue) {
                        ...
                        if (to == keyguardState) {
                            keyguardTransitionRepository = FromOccludedTransitionInteractor.this.keyguardTransitionRepository;
                            String name = FromOccludedTransitionInteractor.this.getName();
                            KeyguardState keyguardState2 = KeyguardState.LOCKSCREEN;
                            m3033getAnimatorLRDsOJo = FromOccludedTransitionInteractor.this.m3033getAnimatorLRDsOJo(FromOccludedTransitionInteractor.Companion.m3034getTO_LOCKSCREEN_DURATIONUwyO8pc());
                            keyguardTransitionRepository.startTransition(new TransitionInfo(name, keyguardState, keyguardState2, m3033getAnimatorLRDsOJo));
                        }
                    }
