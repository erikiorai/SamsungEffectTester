...
/* loaded from: mainsysui33.jar:com/android/systemui/plugins/ActivityStarter.class */
public interface ActivityStarter {
    public static final int VERSION = 2;

    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/ActivityStarter$Callback.class */
    public interface Callback {
        void onActivityStarted(int i);
    }

    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/ActivityStarter$OnDismissAction.class */
