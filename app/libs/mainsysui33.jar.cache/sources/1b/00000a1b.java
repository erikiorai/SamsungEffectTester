...
/* loaded from: mainsysui33.jar:com/airbnb/lottie/LottieDrawable.class */
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    /* loaded from: mainsysui33.jar:com/airbnb/lottie/LottieDrawable$LazyCompositionTask.class */
    ...
    public int getIntrinsicHeight() {
        ...
        return lottieComposition == null ? -1 : (int) (lottieComposition.getBounds().height() * getScale());
    }

    @Override // android.graphics.drawable.Drawable
    public int getIntrinsicWidth() {
        LottieComposition lottieComposition = this.composition;
        return lottieComposition == null ? -1 : (int) (lottieComposition.getBounds().width() * getScale());
    }
    ...
    public void playAnimation() {
        ...
        setFrame((int) (getSpeed() < ActionBarShadowController.ELEVATION_LOW ? getMinFrame() : getMaxFrame()));
        this.animator.endAnimation();
    }
