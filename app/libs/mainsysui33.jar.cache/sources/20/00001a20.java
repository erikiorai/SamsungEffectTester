...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.FromLockscreenTransitionInteractor$listenForLockscreenToAod$1", f = "FromLockscreenTransitionInteractor.kt", l = {210}, m = "invokeSuspend")
/* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromLockscreenTransitionInteractor$listenForLockscreenToAod$1.class */
public final class FromLockscreenTransitionInteractor$listenForLockscreenToAod$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ FromLockscreenTransitionInteractor this$0;

    /* renamed from: com.android.systemui.keyguard.domain.interactor.FromLockscreenTransitionInteractor$listenForLockscreenToAod$1$2  reason: invalid class name */
    /* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromLockscreenTransitionInteractor$listenForLockscreenToAod$1$2.class */
    public final /* synthetic */ class AnonymousClass2 extends AdaptedFunctionReference implements Function3<DozeTransitionModel, TransitionStep, Continuation<? super Pair<? extends DozeTransitionModel, ? extends TransitionStep>>, Object> {
        ...
        public final Object invoke(DozeTransitionModel dozeTransitionModel, TransitionStep transitionStep, Continuation<? super Pair<DozeTransitionModel, TransitionStep>> continuation) {
            return FromLockscreenTransitionInteractor$listenForLockscreenToAod$1.invokeSuspend$lambda$0(dozeTransitionModel, transitionStep, continuation);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FromLockscreenTransitionInteractor$listenForLockscreenToAod$1(FromLockscreenTransitionInteractor fromLockscreenTransitionInteractor, Continuation<? super FromLockscreenTransitionInteractor$listenForLockscreenToAod$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FromLockscreenTransitionInteractor$listenForLockscreenToAod$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow<DozeTransitionModel> dozeTransitionTo = keyguardInteractor.dozeTransitionTo(DozeStateModel.DOZE_AOD);
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromLockscreenTransitionInteractor$listenForLockscreenToAod$1.3
