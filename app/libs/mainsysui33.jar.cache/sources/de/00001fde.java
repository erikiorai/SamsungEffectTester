...
/* loaded from: mainsysui33.jar:com/android/systemui/plugins/statusbar/NotificationMenuRowPlugin.class */
public interface NotificationMenuRowPlugin extends Plugin {
    public static final String ACTION = "com.android.systemui.action.PLUGIN_NOTIFICATION_MENU_ROW";
    public static final int VERSION = 5;

    @ProvidesInterface(version = 1)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem.class */
    ...
    @ProvidesInterface(version = 1)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$OnMenuEventListener.class */
