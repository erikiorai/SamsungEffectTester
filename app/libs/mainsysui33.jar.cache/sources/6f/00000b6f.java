...
/* loaded from: mainsysui33.jar:com/android/keyguard/EmergencyButtonController_Factory_Factory.class */
public final class EmergencyButtonController_Factory_Factory implements Factory<EmergencyButtonController.Factory> {
    ...
    /* renamed from: get */
    public EmergencyButtonController.Factory m552get() {
        return newInstance((ConfigurationController) this.configurationControllerProvider.get(), (KeyguardUpdateMonitor) this.keyguardUpdateMonitorProvider.get(), (TelephonyManager) this.telephonyManagerProvider.get(), (PowerManager) this.powerManagerProvider.get(), (ActivityTaskManager) this.activityTaskManagerProvider.get(), (ShadeController) this.shadeControllerProvider.get(), (TelecomManager) this.telecomManagerProvider.get(), (MetricsLogger) this.metricsLoggerProvider.get());
    }
}