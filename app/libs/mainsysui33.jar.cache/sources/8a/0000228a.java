...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/AmbientDisplayTile_Factory.class */
public final class AmbientDisplayTile_Factory implements Factory<AmbientDisplayTile> {
    ...
    public static AmbientDisplayTile_Factory create(Provider<QSHost> provider, Provider<Looper> provider2, Provider<Handler> provider3, Provider<FalsingManager> provider4, Provider<MetricsLogger> provider5, Provider<StatusBarStateController> provider6, Provider<ActivityStarter> provider7, Provider<QSLogger> provider8, Provider<UserTracker> provider9, Provider<SecureSettings> provider10) {
        return new AmbientDisplayTile_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10);
    }

    public static AmbientDisplayTile newInstance(QSHost qSHost, Looper looper, Handler handler, FalsingManager falsingManager, MetricsLogger metricsLogger, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, UserTracker userTracker, SecureSettings secureSettings) {
        return new AmbientDisplayTile(qSHost, looper, handler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qSLogger, userTracker, secureSettings);
    }

    /* JADX DEBUG: Method merged with bridge method */
    /* renamed from: get */
    public AmbientDisplayTile m3977get() {
