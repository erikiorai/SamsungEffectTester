...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/DndTile_Factory.class */
public final class DndTile_Factory implements Factory<DndTile> {
    ...
    /* renamed from: get */
    public DndTile m4012get() {
        return newInstance((QSHost) this.hostProvider.get(), (Looper) this.backgroundLooperProvider.get(), (Handler) this.mainHandlerProvider.get(), (FalsingManager) this.falsingManagerProvider.get(), (MetricsLogger) this.metricsLoggerProvider.get(), (StatusBarStateController) this.statusBarStateControllerProvider.get(), (ActivityStarter) this.activityStarterProvider.get(), (QSLogger) this.qsLoggerProvider.get(), (ZenModeController) this.zenModeControllerProvider.get(), (SharedPreferences) this.sharedPreferencesProvider.get(), (SecureSettings) this.secureSettingsProvider.get(), (DialogLaunchAnimator) this.dialogLaunchAnimatorProvider.get());
    }
}