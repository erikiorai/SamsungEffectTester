...
/* loaded from: mainsysui33.jar:com/android/app/motiontool/nano/EndTraceResponse.class */
public final class EndTraceResponse extends MessageNano {
    public ExportedData exportedData;

    public EndTraceResponse() {
        clear();
    }

    public EndTraceResponse clear() {
    ...
    public EndTraceResponse m487mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
