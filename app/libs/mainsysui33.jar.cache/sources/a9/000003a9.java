...
/* loaded from: mainsysui33.jar:androidx/core/graphics/ColorUtils.class */
public final class ColorUtils {
    ...
    public static void RGBToHSL(int i, int i2, int i3, float[] fArr) {
        ...
        float f8 = f7;
        if (f7 < ActionBarShadowController.ELEVATION_LOW) {
            f8 = f7 + 360.0f;
        }
        fArr[0] = constrain(f8, (float) ActionBarShadowController.ELEVATION_LOW, 360.0f);
        fArr[1] = constrain(abs, (float) ActionBarShadowController.ELEVATION_LOW, 1.0f);
        fArr[2] = constrain(f6, (float) ActionBarShadowController.ELEVATION_LOW, 1.0f);
    }
    ...
    public static int setAlphaComponent(int i, int i2) {
        ...
        return (i & IStats.Stub.TRANSACTION_getInterfaceVersion) | (i2 << 24);
    }
}