...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1", f = "FromLockscreenTransitionInteractor.kt", l = {64}, m = "invokeSuspend")
/* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1.class */
public final class FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    ...
    /* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1$2.class */
    public final /* synthetic */ class AnonymousClass2 extends AdaptedFunctionReference implements Function3<Boolean, TransitionStep, Continuation<? super Pair<? extends Boolean, ? extends TransitionStep>>, Object> {
        ...
        public final Object invoke(boolean z, TransitionStep transitionStep, Continuation<? super Pair<Boolean, TransitionStep>> continuation) {
            return FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1.invokeSuspend$lambda$0(z, transitionStep, continuation);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1(FromLockscreenTransitionInteractor fromLockscreenTransitionInteractor, Continuation<? super FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow sample = FlowKt.sample(isAbleToDream, keyguardTransitionInteractor.getStartedKeyguardTransitionStep(), AnonymousClass2.INSTANCE);
            final FromLockscreenTransitionInteractor fromLockscreenTransitionInteractor = this.this$0;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromLockscreenTransitionInteractor$listenForLockscreenToDreaming$1.3
