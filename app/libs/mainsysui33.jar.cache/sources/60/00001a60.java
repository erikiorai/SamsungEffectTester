...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$7", f = "KeyguardTransitionAuditLogger.kt", l = {64}, m = "invokeSuspend")
/* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/KeyguardTransitionAuditLogger$start$7.class */
public final class KeyguardTransitionAuditLogger$start$7 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow<TransitionStep> startedKeyguardTransitionStep = keyguardTransitionInteractor.getStartedKeyguardTransitionStep();
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.KeyguardTransitionAuditLogger$start$7.1
                public final Object emit(TransitionStep transitionStep, Continuation<? super Unit> continuation) {
                    ...
                    keyguardLogger.i("Started transition", transitionStep);
            ...
            this.label = 1;
            if (startedKeyguardTransitionStep.collect(flowCollector, this) == coroutine_suspended) {
