...
/* loaded from: mainsysui33.jar:com/android/settingslib/applications/DefaultAppInfo.class */
public class DefaultAppInfo extends CandidateInfo {
    ...
    public final ComponentInfo getComponentInfo() {
        try {
            ComponentInfo activityInfo = AppGlobals.getPackageManager().getActivityInfo(this.componentName, 0L, this.userId);
            ComponentInfo componentInfo = activityInfo;
            if (activityInfo == null) {
                componentInfo = AppGlobals.getPackageManager().getServiceInfo(this.componentName, 0L, this.userId);
            }
