...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/LocationTile_Factory.class */
public final class LocationTile_Factory implements Factory<LocationTile> {
    ...
    /* renamed from: get */
    public LocationTile m4028get() {
        return newInstance((QSHost) this.hostProvider.get(), (Looper) this.backgroundLooperProvider.get(), (Handler) this.mainHandlerProvider.get(), (FalsingManager) this.falsingManagerProvider.get(), (MetricsLogger) this.metricsLoggerProvider.get(), (StatusBarStateController) this.statusBarStateControllerProvider.get(), (ActivityStarter) this.activityStarterProvider.get(), (QSLogger) this.qsLoggerProvider.get(), (LocationController) this.locationControllerProvider.get(), (KeyguardStateController) this.keyguardStateControllerProvider.get());
    }
}