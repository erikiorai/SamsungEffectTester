...
/* loaded from: mainsysui33.jar:com/android/systemui/qs/tiles/CameraToggleTile.class */
public class CameraToggleTile extends SensorPrivacyToggleTile {
    /* JADX DEBUG: Method not inlined, still used in: [com.android.systemui.qs.tiles.CameraToggleTile$$ExternalSyntheticLambda0.get():java.lang.Object] */
    public static /* synthetic */ Boolean $r8$lambda$UtRBYTAzb02VNYRl3lbeOYsaQac() {
    ...
    public boolean isAvailable() {
        return this.mSensorPrivacyController.supportsSensorToggle(2) && ((Boolean) DejankUtils.whitelistIpcs(new Supplier() { // from class: com.android.systemui.qs.tiles.CameraToggleTile$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                return CameraToggleTile.$r8$lambda$UtRBYTAzb02VNYRl3lbeOYsaQac();
            }
        })).booleanValue();
    }
}