...
@DebugMetadata(c = "com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToDreaming$1", f = "FromOccludedTransitionInteractor.kt", l = {53}, m = "invokeSuspend")
/* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromOccludedTransitionInteractor$listenForOccludedToDreaming$1.class */
public final class FromOccludedTransitionInteractor$listenForOccludedToDreaming$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    ...
    /* loaded from: mainsysui33.jar:com/android/systemui/keyguard/domain/interactor/FromOccludedTransitionInteractor$listenForOccludedToDreaming$1$2.class */
    public final /* synthetic */ class AnonymousClass2 extends AdaptedFunctionReference implements Function3<Boolean, KeyguardState, Continuation<? super Pair<? extends Boolean, ? extends KeyguardState>>, Object> {
        ...
        public final Object invoke(boolean z, KeyguardState keyguardState, Continuation<? super Pair<Boolean, ? extends KeyguardState>> continuation) {
            return FromOccludedTransitionInteractor$listenForOccludedToDreaming$1.invokeSuspend$lambda$0(z, keyguardState, continuation);
        }
    }
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.android.systemui.keyguard.domain.interactor.FromOccludedTransitionInteractor$listenForOccludedToDreaming$1.3
                ...
                public final Object emit(Pair<Boolean, ? extends KeyguardState> pair, Continuation<? super Unit> continuation) {
                    ...
                    if (booleanValue && keyguardState2 == (keyguardState = KeyguardState.OCCLUDED)) {
                        ...
                        keyguardTransitionRepository.startTransition(new TransitionInfo(FromOccludedTransitionInteractor.this.getName(), keyguardState, KeyguardState.DREAMING, FromOccludedTransitionInteractor.m3032getAnimatorLRDsOJo$default(FromOccludedTransitionInteractor.this, 0L, 1, null)));
                    }
