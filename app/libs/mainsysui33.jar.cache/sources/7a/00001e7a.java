...
/* loaded from: mainsysui33.jar:com/android/systemui/navigationbar/buttons/ButtonDispatcher.class */
public class ButtonDispatcher {
    ...
    public final ValueAnimator.AnimatorUpdateListener mAlphaListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.navigationbar.buttons.ButtonDispatcher$$ExternalSyntheticLambda0
        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ButtonDispatcher.$r8$lambda$f4CaUAXY75l9uXJoNCgA7v8DY4M(ButtonDispatcher.this, valueAnimator);
        }
    };
    public final AnimatorListenerAdapter mFadeListener = new AnimatorListenerAdapter() { // from class: com.android.systemui.navigationbar.buttons.ButtonDispatcher.1
        {
            ButtonDispatcher.this = this;
        }
    ...
    /* JADX DEBUG: Method not inlined, still used in: [com.android.systemui.navigationbar.buttons.ButtonDispatcher$$ExternalSyntheticLambda0.onAnimationUpdate(android.animation.ValueAnimator):void] */
    public static /* synthetic */ void $r8$lambda$f4CaUAXY75l9uXJoNCgA7v8DY4M(ButtonDispatcher buttonDispatcher, ValueAnimator valueAnimator) {
        buttonDispatcher.lambda$new$0(valueAnimator);
    }
    ...
    public void setCurrentView(View view) {
        ...
        if (view2 != null) {
            view2.setTranslationX(ActionBarShadowController.ELEVATION_LOW);
            this.mCurrentView.setTranslationY(ActionBarShadowController.ELEVATION_LOW);
            this.mCurrentView.setTranslationZ(ActionBarShadowController.ELEVATION_LOW);
        }
    }
