...
/* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile.class */
public interface QSTile {
    public static final int VERSION = 4;

    @ProvidesInterface(version = 1)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile$BooleanState.class */
    public static class BooleanState extends State {
        ...
        public StringBuilder toStringBuilder() {
            ...
            stringBuilder.insert(length - 1, ",value=" + this.value);
            int length2 = stringBuilder.length();
            stringBuilder.insert(length2 - 1, ",forceExpandIcon=" + this.forceExpandIcon);
            return stringBuilder;
        }
    }

    @ProvidesInterface(version = 2)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile$Callback.class */
    ...
    @ProvidesInterface(version = 1)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile$Icon.class */
    ...
    @ProvidesInterface(version = 1)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile$LiveDisplayState.class */
    public static class LiveDisplayState extends State {
        ...
        public StringBuilder toStringBuilder() {
            StringBuilder stringBuilder = super.toStringBuilder();
            int length = stringBuilder.length();
            stringBuilder.insert(length - 1, ",mode=" + this.mode);
            return stringBuilder;
        }
    }

    @ProvidesInterface(version = 1)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile$SignalState.class */
    public static final class SignalState extends BooleanState {
        ...
        public boolean copyTo(State state) {
            ...
            boolean z3 = false;
            boolean z4 = (z == z2 && signalState.activityOut == this.activityOut && signalState.isOverlayIconWide == this.isOverlayIconWide && signalState.overlayIconId == this.overlayIconId) ? false : true;
        ...
        public StringBuilder toStringBuilder() {
            StringBuilder stringBuilder = super.toStringBuilder();
            int length = stringBuilder.length();
            stringBuilder.insert(length - 1, ",activityIn=" + this.activityIn);
            int length2 = stringBuilder.length();
            stringBuilder.insert(length2 - 1, ",activityOut=" + this.activityOut);
            return stringBuilder;
        }
    }

    @ProvidesInterface(version = 2)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile$SlashState.class */
    ...
    @ProvidesInterface(version = 1)
    /* loaded from: mainsysui33.jar:com/android/systemui/plugins/qs/QSTile$State.class */
