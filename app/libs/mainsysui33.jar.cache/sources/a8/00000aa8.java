...
/* loaded from: mainsysui33.jar:com/airbnb/lottie/model/layer/SolidLayer.class */
public class SolidLayer extends BaseLayer {
    ...
    public void getBounds(RectF rectF, Matrix matrix, boolean z) {
        ...
        this.rect.set(ActionBarShadowController.ELEVATION_LOW, ActionBarShadowController.ELEVATION_LOW, this.layerModel.getSolidWidth(), this.layerModel.getSolidHeight());
