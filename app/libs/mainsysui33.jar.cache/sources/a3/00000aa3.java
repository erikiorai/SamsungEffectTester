...
/* loaded from: mainsysui33.jar:com/airbnb/lottie/model/layer/Layer.class */
public class Layer {
    ...
    /* loaded from: mainsysui33.jar:com/airbnb/lottie/model/layer/Layer$LayerType.class */
    ...
    /* loaded from: mainsysui33.jar:com/airbnb/lottie/model/layer/Layer$MatteType.class */
    ...
    public String toString(String str) {
        ...
        if (layerModelForId != null) {
            ...
            while (true) {
                Layer layer = layerModelForId2;
                if (layer == null) {
                    break;
                }
                sb.append("->");
                sb.append(layer.getName());
                layerModelForId2 = this.composition.layerModelForId(layer.getParentId());
            }
            sb.append(str);
            sb.append("\n");
        }
