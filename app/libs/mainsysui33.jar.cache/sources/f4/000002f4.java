...
/* loaded from: mainsysui33.jar:androidx/constraintlayout/widget/ConstraintSet.class */
public class ConstraintSet {
    public static final int[] VISIBILITY_FLAGS = {0, 4, 8};
    public static SparseIntArray sMapToConstant = new SparseIntArray();
    public static SparseIntArray sOverrideMapToConstant = new SparseIntArray();
    ...
    /* loaded from: mainsysui33.jar:androidx/constraintlayout/widget/ConstraintSet$Constraint.class */
    public static class Constraint {
        ...
        /* loaded from: mainsysui33.jar:androidx/constraintlayout/widget/ConstraintSet$Constraint$Delta.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/constraintlayout/widget/ConstraintSet$Layout.class */
    public static class Layout {
        public static SparseIntArray sMapToConstant;
        ...
        public float circleAngle = ActionBarShadowController.ELEVATION_LOW;
        ...
        static {
            ...
            sMapToConstant.append(R$styleable.Layout_layout_constrainedWidth, 41);
            sMapToConstant.append(R$styleable.Layout_layout_constrainedHeight, 42);
    ...
    /* loaded from: mainsysui33.jar:androidx/constraintlayout/widget/ConstraintSet$Motion.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/constraintlayout/widget/ConstraintSet$PropertySet.class */
    ...
    /* loaded from: mainsysui33.jar:androidx/constraintlayout/widget/ConstraintSet$Transform.class */
    public static class Transform {
        public static SparseIntArray sMapToConstant;
        public boolean mApply = false;
        public float rotation = ActionBarShadowController.ELEVATION_LOW;
        public float rotationX = ActionBarShadowController.ELEVATION_LOW;
        public float rotationY = ActionBarShadowController.ELEVATION_LOW;
        public float scaleX = 1.0f;
        public float scaleY = 1.0f;
        public float transformPivotX = Float.NaN;
        public float transformPivotY = Float.NaN;
        public int transformPivotTarget = -1;
        public float translationX = ActionBarShadowController.ELEVATION_LOW;
        public float translationY = ActionBarShadowController.ELEVATION_LOW;
        public float translationZ = ActionBarShadowController.ELEVATION_LOW;
        public boolean applyElevation = false;
        public float elevation = ActionBarShadowController.ELEVATION_LOW;
        ...
        if (substring2.length() > 0) {
            ...
            try {
                if ("weight".equalsIgnoreCase(trim)) {
                    ...
                    float max = Math.max((float) ActionBarShadowController.ELEVATION_LOW, Math.min(1.0f, Float.parseFloat(trim2)));
                    if (obj instanceof ConstraintLayout.LayoutParams) {
                ...
                if (indexOf2 < 0 || indexOf2 >= length - 1) {
                    ...
                    if (substring3.length() > 0) {
                        ...
                        if (substring4.length() > 0) {
                            ...
                            f = Float.NaN;
                            i = i2;
                            if (parseFloat > ActionBarShadowController.ELEVATION_LOW) {
                                f = Float.NaN;
                                i = i2;
                                if (parseFloat2 > ActionBarShadowController.ELEVATION_LOW) {
                                    if (i2 == 1) {
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            ...
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m139clone());
            }
        }
    }
    ...
    public final void populateConstraint(Constraint constraint, TypedArray typedArray, boolean z) {
        if (z) {
