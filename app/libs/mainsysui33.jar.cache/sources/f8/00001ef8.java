...
/* loaded from: mainsysui33.jar:com/android/systemui/people/PeopleBackupFollowUpJob.class */
public class PeopleBackupFollowUpJob extends JobService {
    ...
    public static void scheduleJob(Context context) {
        ...
        jobScheduler.schedule(new JobInfo.Builder(74823873, new ComponentName(context, PeopleBackupFollowUpJob.class)).setPeriodic(JOB_PERIODIC_DURATION).setExtras(persistableBundle).build());
    }
