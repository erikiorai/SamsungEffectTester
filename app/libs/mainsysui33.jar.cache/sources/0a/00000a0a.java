...
/* loaded from: mainsysui33.jar:com/airbnb/lottie/LottieAnimationView.class */
public class LottieAnimationView extends AppCompatImageView {
    ...
    /* loaded from: mainsysui33.jar:com/airbnb/lottie/LottieAnimationView$5.class */
    ...
    /* loaded from: mainsysui33.jar:com/airbnb/lottie/LottieAnimationView$SavedState.class */
    ...
    public long getDuration() {
        LottieComposition lottieComposition = this.composition;
        return lottieComposition != null ? lottieComposition.getDuration() : 0L;
    }
    ...
    public final void init(AttributeSet attributeSet) {
        ...
        setProgress(obtainStyledAttributes.getFloat(R$styleable.LottieAnimationView_lottie_progress, ActionBarShadowController.ELEVATION_LOW));
        ...
        if (Utils.getAnimationScale(getContext()) != ActionBarShadowController.ELEVATION_LOW) {
            z = true;
        }
